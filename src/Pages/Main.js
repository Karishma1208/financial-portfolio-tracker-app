...
import Addstocks from '../Components/AddStocks/Addstocks';
 ...
 class Main extends Component {
     ...
     componentDidMount(){
        axios.get("https://finance-portfolio-tracke-6ebd4.firebaseio.com/company.json")
        .then((response)=>{
        ...
        axios.get("https://finance-portfolio-tracke-6ebd4.firebaseio.com/mystocks.json")
        .then((response)=>{
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://finance-portfolio-tracke-6ebd4.firebaseio.com/company.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://finance-portfolio-tracke-6ebd4.firebaseio.com/mystocks/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://finance-portfolio-tracke-6ebd4.firebaseio.com/mystocks.json', {
                            ...
                            axios.delete(`https://finance-portfolio-tracke-6ebd4.firebaseio.com/company/${id}.json`)
                            .then((response)=>{
